...
DEFAULT_TABLES: dict[str, tuple[list[str], list[list]]] = {
    ...
    "Story Forces": (
        ["Story", "OutputCase", "Location", "P", "VX", "VY", "MX", "MY"],
        [
            ["Story3", "EQX", "Top", "0.0", "100.0", "0.0", "0.0", "400.0"],
            ["Story3", "EQX", "Bottom", "0.0", "100.0", "0.0", "0.0", "0.0"],
            ["Story1", "EQX", "Bottom", "0.0", "300.0", "0.0", "0.0", "0.0"],
        ],
    ),
